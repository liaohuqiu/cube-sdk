...
import net.liaohuqiu.cube.image.imple.DefaultMemoryCache;
import net.liaohuqiu.cube.image.imple.LruImageFileCache;
import net.liaohuqiu.cube.image.util.Downloader;

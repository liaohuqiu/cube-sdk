...
import net.liaohuqiu.cube.app.lifecycle.IComponentContainer;
import net.liaohuqiu.cube.app.lifecycle.LifeCycleComponent;
import net.liaohuqiu.cube.app.lifecycle.LifeCycleComponentManager;

...
public class AsyncHttpClient {
	 ...
	 */
	public AsyncHttpRequest get(String url,
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public AsyncHttpRequest get(Context context, String url,
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public AsyncHttpRequest get(Context context, String url, Header[] headers,
			RequestParams params, AsyncHttpResponseHandler responseHandler) {
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public AsyncHttpRequest post(String url,
			AsyncHttpResponseHandler responseHandler) {
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public AsyncHttpRequest post(String url, RequestParams params,
			AsyncHttpResponseHandler responseHandler) {
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public AsyncHttpRequest post(Context context, String url,
			RequestParams params, AsyncHttpResponseHandler responseHandler) {
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public AsyncHttpRequest post(Context context, String url, Header[] headers,
	...
	public void put(Context context, String url, RequestParams params,
			AsyncHttpResponseHandler responseHandler) {
		put(context, url, paramsToEntity(params, responseHandler), null,
				responseHandler);
	}
	...
	protected AsyncHttpRequest sendRequest(DefaultHttpClient client,
		...
		AsyncHttpRequest httpRequest = new AsyncHttpRequest(client,
	...
	private HttpEntity paramsToEntity(RequestParams params,
			AsyncHttpResponseHandler progressHandler) {

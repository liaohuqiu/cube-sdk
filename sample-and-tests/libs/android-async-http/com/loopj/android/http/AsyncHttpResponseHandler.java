...
public class AsyncHttpResponseHandler {
    ...
    public AsyncHttpRequest context;
    ...
    public void onSuccess(int statusCode, String content) {
    	...
    	context.responseString = content;
        onSuccess(content, context);
    }
    

    /**
     * fired when the request is on progress
     * @param position
     * @param total
     */
    ...
    {
    	onProgress(position,total, context);
    }
     ...
     */
    public void onFailure(Throwable error, AsyncHttpRequest request) {}
    
    public void onFailure(Throwable error, String content) {
  
        context.responseString = content;
        onFailure(error, content, context);
    } 
    ...
    protected void sendProgressMessage(long position, long total)
    {
    	sendMessage(obtainMessage(PROGRESS_MESSAGE, new Object[]{position,total}));
    }
    ...
    protected void handleFailureMessage(Throwable e, String responseBody) {
        onFailure(e, responseBody, context);
    }

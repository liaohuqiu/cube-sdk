...
The latest version: `1.0.44.35`, has been published to: https://oss.sonatype.org/content/repositories/snapshots, in gradle:
...
```
compile 'in.srain.cube:cube-sdk:1.0.44.35@aar'
```

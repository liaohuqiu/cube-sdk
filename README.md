...
The latest version: `1.0.45.3.2-SNAPSHOT`, has been published to: https://oss.sonatype.org/content/repositories/snapshots, in gradle:
...
<dependency>
    ...
    <!-- <type>apklib</type> -->
    <version>1.0.45.3.2-SNAPSHOT</version>
</dependency>
```

...
The latest version: `1.0.44.31-SNAPSHOT`, has been published to: https://oss.sonatype.org/content/repositories/snapshots, in gradle:
...
<dependency>
    ...
    <!-- <type>apklib</type> -->
    <version>1.0.44.31-SNAPSHOT</version>
</dependency>
```
...
```
compile 'in.srain.cube:cube-sdk:1.0.44.31-SNAPSHOT@aar'
```

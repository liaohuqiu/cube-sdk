...
The latest version: `1.0.44.13-SNAPSHOT`, has been published to: https://oss.sonatype.org/content/repositories/snapshots, in gradle:
...
<dependency>
    ...
    <!-- <type>apklib</type> -->
    <version>1.0.44.13-SNAPSHOT</version>
</dependency>
```
